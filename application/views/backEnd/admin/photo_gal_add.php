    ...
    <div class="col-md-12">
      ...
      <div class="box box-purple box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"> <?php echo $this->lang->line('add_photo_gal'); ?> </h3>
          <div class="box-tools pull-right">
            <a href="<?php echo base_url() ?>admin/photo-gal/list" type="submit" class="btn bg-orange btn-sm" style="color: white;"> <i class="fa fa-list"></i> <?php echo $this->lang->line('photo_gal_list'); ?> </a>
          </div>
        </div>
        <div class="box-body">
          <div class="row">
            <form action="<?php echo base_url("admin/photo-gal/add"); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      ...
                      <select name="photo_album_id" id="photo_album_id" class="form-control select2">
                        ...
                        <?php foreach ($photo_album_list_2 as $key => $value) { ?>
              ...
              <div class="col-md-3">
                ...
                <div class="box box-purple">
                  <div class="box-header"> <label style="margin-bottom: 0px;"> <?php echo $this->lang->line('photo_file'); ?> </label> </div>
